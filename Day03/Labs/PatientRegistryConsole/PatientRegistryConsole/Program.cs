...
namespace PatientRegistryConsole
{
    class Program
    {
        ...
        static List<List<string>> prevNames = new List<List<string>>();
        ...
        static void UpdatePatient()
        {
            ...
            {
                prevNames[index].Add(newName);
                patients[index] = newName;

                Console.WriteLine("History of the update:");

                foreach(var name in prevNames[index])
                {
